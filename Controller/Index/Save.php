...
class Save extends Action
{
    ...
    {
        if (!isset($post[FeedbackInterface::AUTHOR_NAME]) || trim($post[FeedbackInterface::AUTHOR_NAME]) === '') {
            throw new LocalizedException(__('Name is missing'));
        }
        if (!isset($post[FeedbackInterface::MESSAGE]) || trim($post[FeedbackInterface::MESSAGE]) === '') {
            throw new LocalizedException(__('Comment is missing'));
        }
        if (!isset($post[FeedbackInterface::AUTHOR_EMAIL]) || false === \strpos($post[FeedbackInterface::AUTHOR_EMAIL], '@')) {
